                    ...
                    AsyncImage(
                        url: URL(string: {
                            if sport == "volleyball" {
                                ...
                                return game.competitions.first?.competitors?[safe: 0]?.team?.logo ?? "https://a.espncdn.com/combiner/i?img=/redesign/assets/img/icons/ESPN-icon-\(sport.lowercased()).png&h=160&w=160&scale=crop&cquality=100"
                            }
                        }())
                    ) { image in
                        image
